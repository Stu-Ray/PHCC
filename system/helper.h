...
// Lightweight load-generation statement logging.
// Controlled by runtime args (preferred):
//   -lsle1 -lslf /path/to/file -lslsN
// Can also set defaults in config.h:
//   LOAD_STMT_LOG_ENABLE / LOAD_STMT_LOG_FILE / LOAD_STMT_LOG_SAMPLE
// Also supports environment variables as fallback/override:
//   LOAD_STMT_LOG_ENABLE=1
//   LOAD_STMT_LOG_FILE=/path/to/file (default: load_statements.log)
//   LOAD_STMT_LOG_SAMPLE=N (log 1 out of every N records, default: 1)
