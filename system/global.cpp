...
#ifndef LOAD_STMT_LOG_ENABLE
#define LOAD_STMT_LOG_ENABLE 0
#endif
#ifndef LOAD_STMT_LOG_FILE
#define LOAD_STMT_LOG_FILE "load_statements.log"
#endif
#ifndef LOAD_STMT_LOG_SAMPLE
#define LOAD_STMT_LOG_SAMPLE 1
#endif

UInt32              g_k_value                   =   K_VALUE;
UInt32              g_predict_topk              =   PREDICT_TOPK;
UInt32              g_predict_mode              =   PREDICT_MODE;
double              g_predict_risk_threshold    =   PREDICT_RISK_THREHOLD;

UInt32              g_min_support       =   MIN_PREDICT_SUPPORT;
UInt32              g_hash_lock_num     =   HASH_LOCK_NUM;
ActiveWsTable       active_ws_table;
WorksetPredictor    workset_predictor;

// #RAIN WorksetPredictor 导入导出配置
bool                g_predictor_import_enable   =   PREDICTOR_IMPORT_ENABLE == 1;
bool                g_predictor_export_enable   =   PREDICTOR_EXPORT_ENABLE == 1;
char              * g_predictor_import_file    =   (char *)PREDICTOR_IMPORT_FILE;
char              * g_predictor_export_file    =   (char *)PREDICTOR_EXPORT_FILE;
...
char * txn_file = NULL;
bool g_load_stmt_log_enable = LOAD_STMT_LOG_ENABLE == 1;
char * g_load_stmt_log_file = (char *)LOAD_STMT_LOG_FILE;
UInt32 g_load_stmt_log_sample = LOAD_STMT_LOG_SAMPLE;
