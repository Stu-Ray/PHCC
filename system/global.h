...
extern  bool              g_load_stmt_log_enable;
extern  char              * g_load_stmt_log_file;
extern  UInt32            g_load_stmt_log_sample;

extern  UInt32            g_k_value;              // 最大预测前缀 K
extern  UInt32            g_predict_topk;         // 预测返回结果数
extern  UInt32            g_predict_mode;         // 预测模式：1 -- pre-exec predict, 2 -- k-step predict
extern  double            g_predict_risk_threshold;

extern  UInt32            g_min_support;          // 最小预测样本支持度
extern  UInt32            g_hash_lock_num;        // 哈希分片锁数量
extern  WorksetPredictor  workset_predictor;      // 工作集预测器
extern  ActiveWsTable     active_ws_table;        // 活跃事务工作集
// #RAIN WorksetPredictor 导入导出配置
extern  bool              g_predictor_import_enable;
extern  bool              g_predictor_export_enable;
extern  char            * g_predictor_import_file;
extern  char            * g_predictor_export_file;
